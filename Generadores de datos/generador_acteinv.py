...
cabeceras_actividad_investigacion = ['categoria', 'area_principal', 'dedicacion', 'dni']
...
print(f"Se generaron {num_records} registros y se exportaron a {archivo_actividad_investigacion}")
